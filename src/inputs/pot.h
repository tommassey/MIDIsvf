...
private:
    ...
    static const uint8_t numReadings = 16;    //  number of averages to take, higher is smoother at expense of performance
...
public:
    pot(uint8_t _pin, float* _externalValue, bool* _changeFlag);
